...
void testApp::keyPressed( int key ) {
    if( key == 's' ) {
		...
		printf("undistort(\n");
		printf("\t%f, %f,\n", calib.distortionCoeffs[0], calib.distortionCoeffs[1]);
		printf("\t%f, %f,\n", calib.distortionCoeffs[2], calib.distortionCoeffs[3]);
		printf("\t%f, %f,\n", calib.camIntrinsics[0], calib.camIntrinsics[4]);
		printf("\t%f, %f\n", calib.camIntrinsics[2], calib.camIntrinsics[5]);
		printf(");\n");
		...
		printf("<distortion>\n");
		printf("\t<coef0>%f</coef0>\n", calib.distortionCoeffs[0]);
		printf("\t<coef1>%f</coef1>\n", calib.distortionCoeffs[1]);
		printf("\t<coef2>%f</coef2>\n", calib.distortionCoeffs[2]);
		printf("\t<coef3>%f</coef3>\n", calib.distortionCoeffs[3]);
		printf("\t<coef4>%f</coef4>\n", calib.camIntrinsics[0]);
		printf("\t<coef5>%f</coef5>\n", calib.camIntrinsics[4]);
		printf("\t<coef6>%f</coef6>\n", calib.camIntrinsics[2]);
		printf("\t<coef7>%f</coef7>\n", calib.camIntrinsics[5]);
		printf("</distortion>\n");
	}
}
